...
public class SemestersContract extends AbstractContract {
  ...
  public interface Qualified {
    ...
    public static final String SEMESTERS_COUNT = TABLE + "." + BaseColumns._COUNT;
    public static final String SEMESTERS_SEMESTER_ID = TABLE + "." + Columns.SEMESTER_ID;
    public static final String SEMESTERS_SEMESTER_TITLE = TABLE + "." + Columns.SEMESTER_TITLE;
    public static final String SEMESTERS_SEMESTER_DESCRIPTION =
        TABLE + "." + Columns.SEMESTER_DESCRIPTION;
    public static final String SEMESTERS_SEMESTER_BEGIN = TABLE + "." + Columns.SEMESTER_BEGIN;
    public static final String SEMESTERS_SEMESTER_END = TABLE + "." + Columns.SEMESTER_END;
    public static final String SEMESTERS_SEMESTER_SEMINARS_BEGIN =
        TABLE + "." + Columns.SEMESTER_SEMINARS_BEGIN;
    public static final String SEMESTERS_SEMESTER_SEMINARS_END =
        TABLE + "." + Columns.SEMESTER_SEMINARS_END;
  }
