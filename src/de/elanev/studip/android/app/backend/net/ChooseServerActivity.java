...
public class ChooseServerActivity extends BaseSlidingFragmentActivity {
	 ...
	 * 
	 */
	public static class ChooseServerFragment extends SherlockListFragment {
		...
		public void onCreate(Bundle savedInstanceState) {
			...
			mAdapter = new ServerAdapter(mContext,
					R.layout.list_item_single_text, getItems());
		}
		...
		public void onListItemClick(ListView l, View v, int position, long id) {
			...
			if (item != null) {
				Prefs.getInstance(getActivity().getApplicationContext())
						.setServer(item);
		...
		public Server[] getItems() {
			 ...
			 */
			Server[] items = new Server[] {
					TempServerDeclares.neueTestumgebung,
