...
public class GeneralArrayAdapter extends ArrayAdapter<ArrayAdapterItem> {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		// NewsListItem ni;
		// LayoutInflater inflater = LayoutInflater.from(this.getContext());
		// convertView = inflater.inflate(R.layout.news_item, parent,
		// false);
		...
		// ni.topicTV.setText(((NewsListItem)
		// getItem(position)).news.topic);
		// ni.bodyTV.setText(Html
		// .fromHtml(((NewsListItem) getItem(position)).news.body));

		// TextItem
		if (getItem(position) instanceof TextItem) {
			TextItem ti;
			LayoutInflater inflater = LayoutInflater.from(this.getContext());
