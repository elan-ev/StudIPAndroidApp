...
import de.elanev.studip.android.app.frontend.courses.CourseOverviewFragment;
...
public class TabbedFragmentActivity extends ActionBarActivity {
   ...
   */
  public static class BasePagerTabsAdapter extends FragmentPagerAdapter implements
     ...
     */
    public BasePagerTabsAdapter(Activity activity,
        FragmentManager fm,
        ViewPager pager,
        ActionBar actionbar) {
      super(fm);
     ...
     */
    public void addTab(ActionBar.Tab tab, int iconRes, int titleRes, Class<?> clss, Bundle args) {
    ...
    public Fragment getItem(int position) {
      ...
      try {
        Method m = info.clss.getMethod("newInstance", Bundle.class);
        Fragment f = (Fragment) m.invoke(null, info.args);
        return f;
      ...
      return CourseOverviewFragment.newInstance(info.args);
    }
