 ...
 * 
 */
public class CourseNewsFragment extends SherlockListFragment implements
		LoaderCallbacks<Cursor> {

	public static String TAG = CourseNewsFragment.class.getSimpleName();
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		((TextView) v.findViewById(R.id.empty_message))
				.setText(R.string.no_course_news);
		return v;
	}
	...
	public Loader<Cursor> onCreateLoader(int id, Bundle data) {
		...
		cursorLoader = new CursorLoader(getActivity(),
				NewsContract.COURSES_CONTENT_URI, NewsQuery.PROJECTION, null,
				null, NewsContract.DEFAULT_SORT_ORDER);
		return cursorLoader;
	}
