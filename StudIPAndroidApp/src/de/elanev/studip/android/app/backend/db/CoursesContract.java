...
public class CoursesContract extends AbstractContract {
     ...
     */
    // courses table
    public static final String CREATE_TABLE_COURSES_STRING = String
            .format("CREATE TABLE IF NOT EXISTS %s (%s INTEGER PRIMARY KEY, %s TEXT UNIQUE, "
                    ...
                    + "%s TEXT, %s TEXT, %s TEXT, %s TEXT);", TABLE_COURSES,
                    Columns.Courses._ID, Columns.Courses.COURSE_ID,
    ...
    public static final String COURSES_JOIN_SEMESTERS = String.format(
            "%s INNER JOIN %s on %s = %s ", TABLE_COURSES,
    ...
    // default sort orders
    public static final String DEFAULT_SORT_ORDER = Qualified.Courses.COURSES_COURSE_TITLE
            + " ASC";

    public static final String COURSE_USERS_DEFAULT_SORT = Qualified
    ...
    public static final class Qualified {
        ...
        public static interface Courses {
            public static final String COURSES_ID = TABLE_COURSES + "."
                    + Columns.Courses._ID;
            public static final String COURSES_COURSE_ID = TABLE_COURSES + "."
                    + Columns.Courses.COURSE_ID;
            public static final String COURSES_COURSE_START_TIME = TABLE_COURSES
                    + "." + Columns.Courses.COURSE_START_TIME;
            public static final String COURSES_COURSE_DURATION_TIME = TABLE_COURSES
                    + "." + Columns.Courses.COURSE_DURATION_TIME;
            public static final String COURSES_COURSE_NUMBER = TABLE_COURSES
                    + "." + Columns.Courses.COURSE_NUMBER;
            public static final String COURSES_COURSE_TITLE = TABLE_COURSES
                    + "." + Columns.Courses.COURSE_TITLE;
            public static final String COURSES_COURSE_SUBTITLE = TABLE_COURSES
                    + "." + Columns.Courses.COURSE_SUBTITLE;
            public static final String COURSES_COURSE_DESCIPTION = TABLE_COURSES
                    + "." + Columns.Courses.COURSE_DESCIPTION;
            public static final String COURSES_COURSE_LOCATION = TABLE_COURSES
                    + "." + Columns.Courses.COURSE_LOCATION;
            public static final String COURSES_COURSE_TYPE = TABLE_COURSES
                    + "." + Columns.Courses.COURSE_TYPE;
            public static final String COURSES_COURSE_SEMESERT_ID = TABLE_COURSES
                    + "." + Columns.Courses.COURSE_SEMESERT_ID;
        ...
        public static interface CourseUsers {
            public static final String COURSES_USERS_TABLE_COURSE_USER_USER_ID = TABLE_COURSE_USER
                    + "." + Columns.CourseUsers.COURSE_USER_USER_ID;
            public static final String COURSES_USERS_TABLE_COURSE_USER_COURSE_ID = TABLE_COURSE_USER
                    + "." + Columns.CourseUsers.COURSE_USER_COURSE_ID;
            public static final String COURSES_USERS_TABLE_COURSE_USER_USER_ROLE = TABLE_COURSE_USER
                    + "." + Columns.CourseUsers.COURSE_USER_USER_ROLE;
        }
